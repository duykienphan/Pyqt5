...
class MainWindow:
    def __init__(self):
        ...
        self.uic.actionTab_1.triggered.connect(self.func_showTab1)
        self.uic.actionTab_2.triggered.connect(self.func_showTab2)
        self.uic.actionTab_3.triggered.connect(self.func_showTab3)
